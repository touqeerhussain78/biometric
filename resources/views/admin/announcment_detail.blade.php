            ...
            <div class="dashboard custom-card pb-5">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Announcement Details</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8 col-lg-10">
                        <div class="grey-bg py-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Announcement Title: <span class="font-brinnan-light">{{$announcment_record->title}}</span></p>
                        </div>
                        <div class="grey-bg mt-3 py-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Message:</p>
                            <p class="font-14 mb-0 grey-text">{{$announcment_record->message}}</p>
                        </div>
                        <div class="grey-bg mt-3 py-3 px-4">
                            ...
                            {{-- <p class="font-14 d-flex align-items-center mb-0 grey-text">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="13" height="13" viewBox="0 0 13 13">
                                    <path id="Icon_material-check-box-outline-blank" data-name="Icon material-check-box-outline-blank" d="M16.056,5.944V16.056H5.944V5.944H16.056m0-1.444H5.944A1.449,1.449,0,0,0,4.5,5.944V16.056A1.449,1.449,0,0,0,5.944,17.5H16.056A1.449,1.449,0,0,0,17.5,16.056V5.944A1.449,1.449,0,0,0,16.056,4.5Z" transform="translate(-4.5 -4.5)" fill="#666"/>
                                </svg>User Abc
                            </p>
                            <p class="font-14 d-flex align-items-center mb-0 grey-text">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="13" height="13" viewBox="0 0 13 13">
                            ...
                            @foreach ($user_annoumcments as $item)
                            <p class="font-14 d-flex align-items-center mb-0 grey-text">
                                @if(isset($item->user))
                                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="13" height="13" viewBox="0 0 13 13">
                                    {{-- <path id="Icon_material-check-box-outline-blank"  data-name="Icon material-check-box-outline-blank" d="M16.056,5.944V16.056H5.944V5.944H16.056m0-1.444H5.944A1.449,1.449,0,0,0,4.5,5.944V16.056A1.449,1.449,0,0,0,5.944,17.5H16.056A1.449,1.449,0,0,0,17.5,16.056V5.944A1.449,1.449,0,0,0,16.056,4.5Z" transform="translate(-4.5 -4.5)" fill="#666"/> --}}
                                </svg>{{$item->user->first_name}}
                                @endif
                                @if($item->user_id == 'all')
                                   <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="13" height="13" viewBox="0 0 13 13">
                                    {{-- <path id="Icon_material-check-box-outline-blank" data-name="Icon material-check-box-outline-blank" d="M16.056,5.944V16.056H5.944V5.944H16.056m0-1.444H5.944A1.449,1.449,0,0,0,4.5,5.944V16.056A1.449,1.449,0,0,0,5.944,17.5H16.056A1.449,1.449,0,0,0,17.5,16.056V5.944A1.449,1.449,0,0,0,16.056,4.5Z" transform="translate(-4.5 -4.5)" fill="#666"/> --}}
                        ...
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Date: <span class="font-14 ml-2 font-brinnan-light">{{$announcment_record->date}}</span></p>
                        </div>
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Time: <span class="font-14 ml-2 font-brinnan-light">{{$announcment_record->time}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
