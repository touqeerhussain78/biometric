            ...
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Edit Blog</h4>
                    </div>
                </div>
                <div class="row">
                ...
                @endif
                <form action="{{route('blog_edit_update',['id' => $blog_record->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                                <label for="" class="custom-label font-16 font-brinnan-regular color-dark-33 ml-3">Title<span class="color-red">*</span> :</label>
                                <input type="text" name="title" class="custom-input white-bg green-input h-auto py-2" value="{{$blog_record->title}}">
                                <label for="" class="custom-label font-16 font-brinnan-regular mt-3 color-dark-33 ml-3">Image<span class="red-text">*</span> :</label>
                                <div class="custom-input green-input white-bg h-auto py-1 d-flex align-items-center justify-content-between">
                                    <p class="font-14 my-0 grey-text"></p>
                                    <label for="upload-webinar" class="site-btn grey-btn px-4 font-15 py-1 mb-0">Upload</label>
                                    <div class="d-none"><input type="file" name="image" id="upload-webinar"></div>
                                </div>
                                <label for="" class="custom-label mt-3 font-16 font-brinnan-regular color-dark-33 ml-3">Text<span class="color-red">*</span> : </label>
                                <textarea name="description" id="" cols="30" rows="6" class="custom-input white-bg green-input h-auto p-3">{{$blog_record->title}}</textarea>
                                <div class="text-right my-4">
                                <input type="submit" value="Update" class="site-btn px-5 font-15 py-2" >
                                    {{-- <button class="site-btn px-5 font-15 py-2" type="button" data-target=".blogUpdated" data-toggle="modal">Update</button> --}}
                                </div>
                            </form>
                        </div>
                    </div>
...
<div class="modal fade blogUpdated" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body-content text-center px-lg-5 px-4">
            ...
            <h3 class="font-30 color-dark-33 font-brinnan-regular mt-4">Blog Updated Successfully!</h3>
        </div>
    </div>
  </div>
</div>
