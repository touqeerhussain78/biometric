            ...
            <div class="dashboard custom-card pb-5">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold">Feedback Details</h4>
                        <h4 class="font-25 color-dark-33 font-brinnan-regular mb-0">Feedback Information</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8 col-lg-10">
                        <div class="grey-bg py-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">First Name: <span class="font-brinnan-light font-16 ml-2">{{$feedback_detail->first_name}}</span></p>
                        </div>
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Last Name: <span class="font-brinnan-light font-16 ml-2">{{$feedback_detail->last_name}}</span></p>
                        </div>
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Email: <span class="font-brinnan-light font-16 ml-2">{{$feedback_detail->email}}</span></p>
                        </div>
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Subject: <span class="font-brinnan-light font-16 ml-2">{{$feedback_detail->subject}}</span></p>
                        </div>
                        <div class="grey-bg py-3 mt-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Date: <span class="font-14 ml-2 font-brinnan-light">{{$feedback_detail->created_at->format('m/d/Y')}}</span></p>
                        </div>
                        <div class="grey-bg mt-3 py-3 px-4">
                            <p class="font-20 d-grey-text mb-0 font-brinnan-regular">Message:</p>
                            <p class="font-14 mb-0 grey-text">{{$feedback_detail->message}}</p>
                        </div>
                    </div>
                </div>
            </div>
