        ...
        <div class="dashboard custom-card">
            <div class="row">
                <div class="col-12">
                    <div class="d-md-flex align-items-center justify-content-between">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Edit Portfolio</h4>
                        <div class="d-sm-flex align-items-center">
                            <button class="site-btn green-border px-3 mt-md-0 font-15 mr-sm-3 mt-3 py-2" data-toggle="modal" data-target=".contentUpdated">Upload New Image</button>
                            <button class="site-btn px-5 mt-md-0 font-15 mt-3 py-2" data-toggle="modal" data-target=".contentUpdated">Update</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 mt-3">
                    <p class="font-14 grey-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo. Proin sodales pulvinar sic tempor. Sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6 mt-3">
                    <div class="blog-card">
                        <img src="assets/images/content-img-1.png" alt="" class="img-fluid w-100">
                        <div class="d-sm-flex align-items-center justify-content-center">
                            ...
                            <button class="site-btn mt-3 font-15 px-4 py-2">Upload</button>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 mt-3">
                    <div class="blog-card">
                        <img src="assets/images/content-img-2.png" alt="" class="img-fluid w-100">
                        <div class="d-sm-flex align-items-center justify-content-center">
                            <button class="site-btn mt-3 font-15 green-border px-4 py-2 mr-sm-3">
                                <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="13.019" height="15.895" viewBox="0 0 13.019 15.895">
                                    <g id="Group_196" data-name="Group 196" transform="translate(-1412.491 -568.75)">
                ...
                <div class="col-xl-4 col-md-6 mt-3">
                    <div class="blog-card">
                        <img src="assets/images/content-img-3.png" alt="" class="img-fluid w-100">
                        <div class="d-sm-flex align-items-center justify-content-center">
                            <button class="site-btn mt-3 font-15 green-border px-4 py-2 mr-sm-3">
                                <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="13.019" height="15.895" viewBox="0 0 13.019 15.895">
                                    <g id="Group_196" data-name="Group 196" transform="translate(-1412.491 -568.75)">
