    ...
    <div id="page-content-wrapper" data-scrollbar>
        <div id="configuration">
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12">
                        <h3 class="font-30 color-dark-33 font-brinnan-bold main-top-heading">Edit User</h3>
                    </div>
                        ...
                        <div class="profile-card px-lg-5 py-4 px-sm-4 p-3">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-7 mt-3">
                                    <input type="text" name="first_name" class="custom-input" value="{{$user_record->first_name}}">
                                </div>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-sm-5 mt-3">
                                ...
                                <div class="col-sm-7 mt-3">
                                    <input type="text" name="last_name" class="custom-input" value="{{$user_record->last_name}}">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6 mt-3">
                                    <p class="font-18 mb-0 grey-text font-brinnan-light">{{$user_record->email}}</p>
                                </div>
                                <div class="col-12 mt-4 text-center">
                                    <input type="submit" class="site-btn px-5 py-2" value="Update">
                                    {{-- <button class="site-btn px-5 py-2" type="button" data-target=".profileUpdated" data-toggle="modal">Update</button> --}}
                                </div>
                            </div>
                        </form>
                        </div>
...
<div class="modal fade userUpdated" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body-content text-center">
            ...
            <h3 class="font-30 color-dark-33 font-brinnan-regular mt-4">User Updated Successfully!</h3>
        </div>
    </div>
  </div>
</div>
