        ...
        <div id="configuration">
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Add New Blog</h4>
                    </div>
                </div>
                <div class="row">
            ...
            <form action="{{route('blog_save')}}" method="POST" enctype="multipart/form-data">
                @csrf
                                ...
                                <input type="text" name="title" class="custom-input white-bg green-input h-auto py-2" placeholder="Enter Title">
                                ...
                                <div class="custom-input green-input white-bg h-auto py-1 d-flex align-items-center justify-content-between">
                                    <p class="font-14 my-0 grey-text">Add image</p>
                                ...
                                <textarea name="description" id="" cols="30" rows="6" placeholder="Enter Text" class="custom-input white-bg green-input h-auto p-3"></textarea>
                                <div class="text-right my-4">
                                    <input type="submit" value="Publish" class="site-btn px-5 font-15 py-2">
                                    {{-- <button  type="button" data-target=".blogAdded" data-toggle="modal">Publish</button> --}}
                                </div>
                            </form>
                        </div>
                    </div>
...
<div class="modal fade blogAdded" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body-content text-center px-lg-5 px-4">
            ...
            <h3 class="font-30 color-dark-33 font-brinnan-regular mt-4">New Blog Published Successfully!</h3>
        </div>
    </div>
  </div>
</div>
