            ...
            <div class="dashboard custom-card pb-5">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold">Hands-on Experience Request Details</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8 col-lg-10">
                        <div class="grey-bg py-3 px-4">
                            <h4 class="font-25 color-dark-33 font-brinnan-regular mb-0">User Information</h4>
                            <div class="white-bg p-3 mt-2">
                                 @if(isset($hand_on->first_name))
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">First Name:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->first_name}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Last Name:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->last_name}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Email:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->email}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Date:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->created_at->format('m/d/Y')}}</p>
                                    </div>
                                </div>
                                @endif
                            </div>
                               @if(isset($hand_on->institute))
                            <h4 class="font-25 color-dark-33 mt-4 font-brinnan-regular mb-0">Education:</h4>
                            <div class="white-bg p-3 mt-2">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Institute:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->institute}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Degree Title:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->degree_title}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">From:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->from}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">To:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->to}}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
                            @if(isset($hand_on->work_experience))
                            <h4 class="font-25 color-dark-33 mt-4 font-brinnan-regular mb-0">Work Experience:</h4>
                            <div class="white-bg p-3 mt-2">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Institute:</p>
                                    ...
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->work_experience}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">Designation:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->designation}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">From:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->work_from}}</p>
                                    </div>
                                    <div class="col-md-4 col-sm-6 ">
                                        <p class="font-20 d-grey-text mb-2 font-brinnan-regular">To:</p>
                                    </div>
                                    <div class="col-md-8 col-sm-6 ">
                                        <p class="font-brinnan-light font-16 mb-2 ">{{$hand_on->work_to}}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
