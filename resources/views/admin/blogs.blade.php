                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Blogs</h4>
                            <a class="site-btn px-5 mt-sm-0 mt-3 py-2" href="{{route('blog_add')}}">Add New</a>
                        </div>
                    </div>
                </div>
                <div class="grey-bg">
                    <div class="row  align-items-end">
                       <form action="{{route('blog_filter')}}" method="POST">
                            @csrf
                                        ...
                                        <td>
                                            <div class="btn-group custom-dropdown ml-2 mb-1">
                                                ...
                                                <div class="dropdown-menu last-drop">
                                                    <a href="{{route('blog_detail',['id'=>$item->id])}}" class="dropdown-item">
                                                    ...
                                                    Details</a>
                                                    <a href="{{route('blog_edit',['id' => $item->id])}}" class="dropdown-item">
