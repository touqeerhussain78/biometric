        ...
        <div id="configuration">
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="d-xl-flex align-items-center justify-content-between">
                            <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Course Details</h4>
                                ...
                                <a class="site-btn px-4 mt-md-0 mr-2 mt-3 py-2" href="{{route('go_live')}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="17.909" viewBox="0 0 27 17.909">
                                        <g id="Group_403" data-name="Group 403" transform="translate(-1220 -122)">
                                            ...
                                            <path id="Path_95" data-name="Path 95" d="M3.773,7.5h12.5a2.273,2.273,0,0,1,2.273,2.273V21.136a2.273,2.273,0,0,1-2.273,2.273H3.773A2.273,2.273,0,0,1,1.5,21.136V9.773A2.273,2.273,0,0,1,3.773,7.5Z" transform="translate(1219.5 115.5)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                                        </g>
                                    </svg>
                                   Go Live
                                </a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-8 mt-3">
                        <div class="course-card px-lg-5 p-4">
                            ...
                            <div class="l-grey-bg py-3 px-4">
                                <p class="grey-text mb-2 font-14">{{$course_record->description}}</p>
                            </div>
                            <p class="font-20 mt-3 d-grey-text">Course Summary:</p>
                            <div class="l-grey-bg py-3 px-4">
                                <p class="grey-text mb-2 font-14">{{$course_record->summary}}</p>
                            </div>
                            <p class="font-20 mt-3 d-grey-text">Course Objective:</p>
                            <div class="l-grey-bg py-3 px-4">
                                <ul class="course-list">
                                    @foreach ($course_record->course_objective as $item)
                                    <li class="font-14 grey-text"><i class="fas fa-circle color-pink font-12 mr-2"></i>{{$item->title}}</li>
                                    @endforeach
                                </ul>
                            </div>
                            <p class="font-20 mt-3 d-grey-text">Enrollment Question:</p>
                            <div class="l-grey-bg py-3 px-4">
                                <ul class="course-list">
                                    @foreach ($course_record->question as $item)
                                    <li class="font-14 grey-text"><i class="fas fa-circle color-pink font-12 mr-2"></i>{{$item->question}}</li>
                                    @endforeach
                                </ul>
                            </div>
                            <div class="l-grey-bg mt-4 py-3 px-4">
                                <div class="d-sm-flex align-items-center">
                                    <p class="font-18 mb-0 d-grey-text mr-sm-5">Cost:</p>
                                    <p class="font-14 mt-sm-0 mt-2 mb-0 d-grey-text">{{$course_record->cost}}</p>
                                </div>
                                <div class="d-sm-flex align-items-center">
                                    <p class="font-18 mt-2 mb-0 d-grey-text mr-sm-5">Total Slots:</p>
                                    <p class="font-14 mt-2 mb-0 d-grey-text">{{$course_record->slots}}</p>
                                </div>
                                ...
                                <div class="d-sm-flex align-items-center">
                                    <p class="font-18 mt-2 mb-0 d-grey-text mr-sm-5">Status:</p>
                                    <p class="font-14 mt-2 mb-0 d-grey-text">{{$course_record->status}}</p>
                                </div>
                                <div class="d-sm-flex align-items-center">
                                    <p class="font-18 mt-2 mb-0 d-grey-text mr-sm-5">Last date for Enrollment:</p>
                                    <p class="font-14 mt-2 mb-0 d-grey-text">{{$course_record->enrollment_to}}</p>
                                </div>
                                <div class="d-md-flex align-items-center justify-content-between">
                                    <div class="d-sm-flex align-items-center">
                        ...
                        <div class="text-right mt-4">
                            ...
                            <a class="site-btn font-15 py-2 px-5" href="{{route('media_add',['id'=>$course_record->id])}}">Add New</a>
                        </div>
                    </div>
                </div>
                @endif
                <div class="row">
                    <div class="col-12 mb-3">
                        {{-- <div class="d-md-flex align-items-center justify-content-between">
                            <h4 class="font-30 mt-2 color-dark-33 font-brinnan-bold mb-0">Course Media</h4>
                            <div class="d-sm-flex justify-content-end align-items-end">
                                <div class="text-field mt-2 width-260 mr-sm-5">
                                    <input type="text" placeholder="Search here..." class="w-100">
                                </div>
                                <div class="select-field mt-2 width-130">
                ...
                <div class="grey-bg">
                    <div class="row  align-items-end">
                       <form action="{{route('course_media_filter')}}" method="POST">
                            @csrf
                        ...
                        <div class="custom-table table-responsive">
                            <table>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="btn-group dropleft custom-dropdown ml-2 mb-1">
                                                ...
                                                <div class="dropdown-menu custom-dropdown-menu">
                                                    ...
                                                    <a  href="{{route('media_details',['id' => $item->id])}}" class="dropdown-item">
                                                    ...
                                                    Details</a>
                                                    <a href="{{route('media_edit',['id' => $item->id])}}" class="dropdown-item">
                                    ...
                                    @if(isset($course_media_filter))
                                    @foreach ($course_media_filter as $item)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$item->title}}</td>
                                        <td>{{$item->created_at->format('m/d/Y') }}</td>
