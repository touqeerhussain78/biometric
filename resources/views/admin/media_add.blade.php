                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Add New Media</h4>
                                <input type="submit" class="site-btn px-5 mt-sm-0 mt-3 py-2" value="Add">
                                {{-- <button class="site-btn px-5 mt-sm-0 mt-3 py-2" type="button" data-toggle="modal" data-target=".mediaAdded">Add</button> --}}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-12">
                            <input type="hidden" name="course_id" value="{{$course_id}}">
                                <label for="" class="font-20 font-brinnan-regular d-grey-text">Title<span class="red-text">*</span> :</label>
                                <input type="text" name="title" class="custom-input green-input h-auto py-2" placeholder="Enter Title">
                                <label for="" class="font-20 font-brinnan-regular mt-3 d-grey-text">Description<span class="red-text">*</span> :</label>
                                <textarea name="description" class="custom-input green-input h-auto py-2" rows="8" placeholder="Enter Description"></textarea>
                                <label for="upload-file" class="site-btn mt-3 px-5 py-2">Upload File</label>
                                <div class="d-none"><input type="file" name="media" id="upload-file"></div>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade mediaAdded" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body-content text-center px-lg-5 px-4">
            ...
            <h3 class="font-30 color-dark-33 font-brinnan-regular mt-4">Media Added Successfully!</h3>
        </div>
    </div>
  </div>
</div>
