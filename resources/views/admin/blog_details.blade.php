                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Blog Details</h4>
                            <a class="site-btn px-5 mt-sm-0 font-15 mt-3 py-2" href="{{route('blog_edit',['id'=>$blog_record->id])}}">Edit</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-lg-4 mt-3">
                        <div class="blog-card">
                            ...
                            <div class="blog-card-body pt-3">
                                ...
                                <p class="grey-text font-14 mb-0">{{$blog_record->description}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
