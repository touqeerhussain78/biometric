            ...
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Go Live</h4>
                    </div>
                    <div class="col-xl-8 col-lg-10 col-12 mx-auto">
                        <div class="course-card p-3 position-relative">
                            <img src="assets/images/live.png" alt="" class="img-fluid w-100">
                            <img src="assets/images/live-inner.png" alt="" class="img-fluid w-100 px-5 pt-4 live-inner">
                        </div>
                        <div class="text-center">
                            <p class="font-18 font-brinnan-regular my-3 d-grey-text">
                                <svg xmlns="http://www.w3.org/2000/svg" width="34.913" height="22" viewBox="0 0 34.913 22">
                                    <path id="video-camera" d="M34.552,1.962a.74.74,0,0,0-.732-.013L25.809,6.323V3.7A3.7,3.7,0,0,0,22.11,0H3.7A3.7,3.7,0,0,0,0,3.7V18.3A3.7,3.7,0,0,0,3.7,22H22.11a3.7,3.7,0,0,0,3.7-3.7V15.725L33.82,20.1a.74.74,0,0,0,1.094-.649V2.6a.739.739,0,0,0-.362-.636ZM24.329,18.3a2.221,2.221,0,0,1-2.219,2.219H3.7A2.221,2.221,0,0,1,1.48,18.3V3.7A2.222,2.222,0,0,1,3.7,1.479H22.11A2.222,2.222,0,0,1,24.329,3.7Zm9.106-.1-7.626-4.164V8.008l7.626-4.163Zm0,0" transform="translate(-0.001 0)" fill="#333"/>
                                </svg> Camera Preview
                            </p>
                            <a class="site-btn px-5 py-2" href="{{route('start_live')}}">Start Live</a>
                        </div>
                    </div>
                </div>
            </div>
