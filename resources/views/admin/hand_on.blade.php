            ...
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Hands-on Experience Requests</h4>
                    </div>
                </div>
                <div class="grey-bg">
                    <div class="row  align-items-end">
                       <form action="{{route('hand_on_filter')}}" method="POST">
                            @csrf
                                ...
                                <tbody>
                                   @php
                                        ...
                                        <td>
                                            <div class="btn-group custom-dropdown ml-2 mb-1">
                                                ...
                                                <div class="dropdown-menu last-drop">
                                                    <a href="{{route('hand_on_detail',['id'=>$item->id])}}" class="dropdown-item">
                                    ...
                                    @php
                                        $i=1;
                                    @endphp
                                    @if(isset($hand_on_filter))
                                      @foreach ($hand_on_filter as $item)
                                    <tr>
                                        <td>{{$i++}}</td>
                                        <td>{{$item->first_name}}</td>
                                        <td>{{$item->last_name}}</td>
