            ...
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                        <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Add New Webinar</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-8 col-lg-10 mt-3">
                        <div class="grey-bg px-lg-5 p-4">
                            <form action="{{route('webinar_store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <textarea  id="" name="description" cols="30" rows="6" placeholder="Enter Description" class="custom-input white-bg green-input h-auto p-3"></textarea>
                                ...
                                <input type="text" name="charges" class="custom-input green-input white-bg h-auto py-2" placeholder="Enter Charges">
                                <div class="text-right my-4">
                                    <input type="submit" class="site-btn px-5 font-15 py-2" value="Add">
...
<div class="modal fade webinarAdded" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        ...
        <div class="modal-body-content text-center px-lg-5 px-4">
            ...
            <h3 class="font-30 color-dark-33 font-brinnan-regular mt-4">New Webinar Added Successfully!</h3>
        </div>
    </div>
  </div>
</div>
