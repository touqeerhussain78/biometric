                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Media Details</h4>
                            <a class="site-btn px-5 mt-sm-0 mt-3 py-2" href="{{route('media_edit',['id'=>$course_media->id])}}">Edit</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-3">
                                <div class="course-card p-3 text-center">
                                    ...
                                    <p class="font-14 grey-text">{{$course_media->title}}</p>
                                    <a href="{{asset('course_media')}}/{{$course_media->media}}" target="_blank" class="site-btn green-btn px-5 py-2">View File</a>
                                </div>
                            </div>
