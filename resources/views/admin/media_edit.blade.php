            ...
            <div class="dashboard custom-card">
                <div class="row">
                    <div class="col-12 mb-3">
                          <form action="{{route('media_update',['id'=>$course_media->id])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="{{$course_media->id}}">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h4 class="font-30 color-dark-33 font-brinnan-bold mb-0">Edit Media</h4>
                                <button class="site-btn px-5 mt-sm-0 mt-3 py-2" type="submit">Update</button>
                            </div>
                            <div class="row">
                                <div class="col-xl-11 col-12">
                                    <div class="row">
                                        <div class="col-md-6 mt-3">
                                            <div class="course-card p-3 text-center">
                                                <div class="text-right">
                                                    <button class="transparent-btn" type="button">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
                                                            <g id="Group_300" data-name="Group 300" transform="translate(-1472 -411)">
                                                ...
                                                <img src="assets/images/media-img.png" alt="" class="img-fluid">
                                                <p class="mt-3 mb-1 font-18 d-grey-text font-brinnan-regular">{{$course_media->title}}</p>
                                                <p class="font-14 grey-text">{{$course_media->description}}</p>
                                                <label class="site-btn green-btn px-5 py-2" for="upload-media">Upload</label>
                                                <div class="d-none"><input type="file" name="media" id="upload-media"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
