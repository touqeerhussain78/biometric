                        ...
                        <div class="noti-card mt-4 p-sm-4 p-3">
                            <div class="media">
                                ...
                                <div class="media-body ml-3">
                                    <p class="grey-text mb-0">{{ json_decode($notification->data, false)->message }}</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="font-14 mb-0 color-pink">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($notification->created_at))->diffForHumans() }}</p>
                            </div>
                        </div>
                         @endforeach
                        {{-- <div class="media">
